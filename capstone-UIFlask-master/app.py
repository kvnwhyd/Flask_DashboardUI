...
def index():
    ...
    rev_table2 = playstore.groupby(['Category']).agg({
      'Price': 'sum',
      'Reviews': 'mean',
      'Rating': 'mean',
      'Size': 'mean',
    ...
    X = rev_table2['Reviews'].values # axis x
    Y = rev_table2['Rating'].values # axis y
    area = rev_table2['Size'].values/10000 # ukuran besar/kecilnya lingkaran scatter plot
    fig = plt.figure(figsize=(5,5))
    fig.add_subplot()
